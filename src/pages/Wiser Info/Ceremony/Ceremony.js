...
export default function Ceremony() {
    ...
    const tvContent = (
        <div className="content">
            ...
            <p>中旺新聞　美Wiser球典禮　各國球隊參與盛會 (03-07-2013)</p>
            <YoutubeEmbed  embedId="r6EJx2U-ANw"/>
        </div>
    )

    const content = [{ title: "Press Release", content: pressContent }, { title: "News Reports", content: newsContent }, { title: "TV Reports", content: tvContent}]
